...
init
download_source $PROG $PROG ${VER}rc$RC
patch_source
prep_build autoconf -autoreconf
build
launch_testsuite
test_dtrace
# Use a low version so that it is not newer than the official release
# when it comes.
VER=0.$VER.$RC make_package
clean_up
