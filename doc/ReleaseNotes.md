...
- `libxml2` has been updated to version 2.13.9, fixing
  [multiple security issues](https://gitlab.gnome.org/GNOME/libxml2/-/releases/v2.13.9)
  including out-of-bounds memory accesses and integer overflows in the XML
  parser.
...
- The `mpt_sas` driver failed to issue writes larger than 1MB -
  see [illumos 5012](https://www.illumos.org/issues/5012).

- [scsi_vhci(4D)](https://man.omnios.org/scsi_vhci) can now be configured
  to use a different load balancing policy for individual logical units -
  see [illumos 17773](https://www.illumos.org/issues/17773).

<br>

---

## r151054bf (2026-06-12)
...
* Some zone brands were unable to install images compressed with 'xz'; this
  has been corrected.
